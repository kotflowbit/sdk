...
type GreeterClient interface {
	BlockHeight(ctx context.Context, in *HeightRequest, opts ...grpc.CallOption) (*Block, error)
}
...
func (c *greeterClient) BlockHeight(ctx context.Context, in *HeightRequest, opts ...grpc.CallOption) (*Block, error) {
	out := new(Block)
...
type GreeterServer interface {
	BlockHeight(context.Context, *HeightRequest) (*Block, error)
...
func (UnimplementedGreeterServer) BlockHeight(context.Context, *HeightRequest) (*Block, error) {
